        ...
        ig.Entity.inject({
            ...
            show(...args) {
                if (MenuOptions.loudEntitiesEnabled) {
                    if (this instanceof ig.ENTITY.Enemy ||
                        this instanceof ig.ENTITY.MultiHitSwitch ||
                        this instanceof ig.ENTITY.Switch ||
                        this instanceof ig.ENTITY.OneTimeSwitch ||
                        this instanceof ig.ENTITY.Destructible
                    ) {
            ...
            update(...args) {
                ...
                if (this instanceof ig.ENTITY.MultiHitSwitch || this instanceof ig.ENTITY.OneTimeSwitch) {
                    if (this.isOn) {
                        this.playAtSoundHandle?.stop()
                    }
                }
