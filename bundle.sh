...
dior_version="$(jq '.dependencies["cc-diorbital-menu"]' ccmod.json | tail -c +4 | head -c -2)"
dior_url="https://github.com/krypciak/cc-diorbital-menu/releases/download/v${dior_version}/cc-diorbital-menu-${dior_version}.ccmod"
...
[ ! -f pack/assets/mods/cc-diorbital-menu* ] && wget "${dior_url}" -O "pack/assets/mods/cc-diorbital-menu-${dior_version}.ccmod"
